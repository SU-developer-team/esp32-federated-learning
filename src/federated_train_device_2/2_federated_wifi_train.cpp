/*******************************************************
 * Purpose: run encrypted federated learning on device 2
...
#include "federated_train_device_2/device_2_dataset_embedded.h"
#include "federated_train_device_2/device_2_dataset_test.h"
