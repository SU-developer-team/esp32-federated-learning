/*******************************************************
 * Purpose: run encrypted federated learning on device 3
...
#include "federated_train_device_3/device_3_dataset_embedded.h"
#include "federated_train_device_3/device_3_dataset_test.h"
