...
- [mqtt_present](/d:/esp32_federated/src/mqtt_present), [mqtt_simon](/d:/esp32_federated/src/mqtt_simon), and [mqtt_speck](/d:/esp32_federated/src/mqtt_speck) are MQTT demos for lightweight ciphers.
...
- [speck_mqtt_server.py](/d:/esp32_federated/server/speck_mqtt_server.py) is the MQTT-based server variant.
- [rlhabc_server.py](/d:/esp32_federated/server/rlhabc_server.py) is a separate server experiment.
...
```bash
pio run -e federated_secure_upload
pio run -e federated_secure_upload -t upload
pio device monitor -b 115200
```

Upload a specific federated client:
